 ...
 * =========================================================================
 */
package io.arxila.javaruntype;

import java.io.InputStream;
import java.util.Properties;

/**
 * Class meant to keep some constants related to the version of the JavRuntype library being used, build date, etc.
 * <p>
 * This can be used in conditional code that requires a specific version of the library to be present.
 */
public final class JavaRuntype {
    ...
    private static final String RESOURCE_NAME = "io/arxila/javaruntype/javaruntype.properties";
        ...
        if (VERSION == null || VERSION.trim().isEmpty()) {
            ...
            try {
                ...
                throw new ExceptionInInitializerError(
                        "Exception during initialization of javaruntype versioning utilities. " +
                            "Identified javaruntype version is '" + VERSION + "', which does not follow " +
    ...
    private static InputStream findResourceAsStream() {
        ...
        if (contextClassLoader != null) {
            final InputStream inputStream = contextClassLoader.getResourceAsStream(JavaRuntype.RESOURCE_NAME);
            if (inputStream != null) {
                return inputStream;
            }
        }
        ...
        final ClassLoader classClassLoader = JavaRuntype.class.getClassLoader();
        return (classClassLoader != null) ? classClassLoader.getResourceAsStream(JavaRuntype.RESOURCE_NAME) : null;
