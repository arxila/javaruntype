...
/**
 * <p>
 * Basic class of the type system. A <kbd>Type</kbd> object representes a Java type including its type parameters (if it has any),
 * as specified by the {@link TypeDef} corresponding to the type's component class.
 * </p>
 * <p>
 * Every possible Java type can be represented by a <kbd>Type</kbd> object. Some examples:
 * </p>
 *   <ul>
 *     <li><kbd>java.lang.String</kbd></li>
 *     <li><kbd>java.util.List&lt;java.lang.Integer&gt;</kbd></li>
 *     <li><kbd>java.util.Comparator&lt;? super java.util.Map&lt;java.lang.String, ? extends java.lang.Number&gt;&gt;</kbd></li>
 *   </ul>
 *   
 * <p>
 * Objects of this class are never created directly. To obtain a <kbd>Type</kbd> object,
 ...
 * prevents the same <kbd>Type</kbd> from being instantiated more than once (so, if two 
